...
const Buttons = ({ setFilter, filter, onButtonClick }) => {
  ...
  return (
    <div className="nav-button">
      <button
        className={`buttons todo ${buttonStates.assigned ? "selected" : ""}`}
        onClick={() => handleButtonClick("assigned")}
      >
        To - Do
      </button>
      <button
        className={`buttons done ${buttonStates.done ? "selected" : ""}`}
        onClick={() => handleButtonClick("done")}
      >
        Done
      </button>
      <button
        className={`buttons missing ${buttonStates.missing ? "selected" : ""}`}
